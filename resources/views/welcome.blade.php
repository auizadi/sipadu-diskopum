    ...
    <nav
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="{{asset('logo-lmg.png')}}" class="h-10" alt="sipadu">
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SIPADU</span>
            </a>
            <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                @if (Route::has('login'))
                    <nav class="flex items-center justify-end gap-4">
                        ...
                        @else
                            <a href="{{ route('login') }}"
                                class="inline-block px-5 py-1.5 text-white font-semibold border border-transparent hover:border-[#19140035] dark:hover:border-[#3E3E3A] rounded-sm text-sm leading-normal">
                                Log in
                            </a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}"
                                    class="inline-block px-5 py-1.5 text-white font-semibold bg-blue-500 hover:bg-blue-700 rounded-sm text-sm leading-normal">
                                    Register
                                </a>
                            @endif
                        @endauth
